...
import uz.farxod.mobileoperators.databinding.FragmentUcellMainBinding

class UcellMainFragment : Fragment() {

    private var _binding: FragmentUcellMainBinding? = null
    private val binding get() = _binding!!
    private var increment = 0

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        _binding = FragmentUcellMainBinding.inflate(inflater, container, false)
        return binding.root
    }
